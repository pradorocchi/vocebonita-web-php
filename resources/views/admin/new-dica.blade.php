        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Adicionar Dica</div>
                    ...
                    <div class="panel-body">
                        ...
                        @else
                            ...
                            <form method="post" action="/dicas">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="title-color">Cor do título: <span
                                                    style="color: red">*</span></label>
                                        <input type="text" class="form-control" id="title-color" name="title_color"
                                               value="#E14F64">
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <a style="position: relative; top: 33px;" href="http://www.color-hex.com/"
                                           target="_blank">Pesquisar Cores</a>
                                    </div>
                                </div>
                                <br>
